...
Some very commonly and widely used ones are:
...
#### Merge Sort
It is a type of sorting algorithm which relies on the concept of repeated spitting and sorting of data arrays followed by merging to yield the final sorted array. Read more about it here:
